...
O mesmo arquivo também carrega o CSS utilizado pelo selo.
...
```text
view/frontend/web/css/sustainable-seal.css
```

O arquivo é responsável apenas pela apresentação visual do selo.

A lógica de exibição continua isolada no template.
